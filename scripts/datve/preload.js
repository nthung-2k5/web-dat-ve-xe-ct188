...
await (async () => {
    ...
    try {
        // 2. Tìm tuyến xe tương ứng với routeId
        /**
         * @type {import('../api/routes').Route}
         */
        const selectedRoute = findRouteById(routeId);
        ...
        // 3. Lấy các phần tử trên DOM bằng ID
        ...
        // 4. Cập nhật thông tin lên giao diện
        ...
        // 5. Lưu giá vé vào một data attribute để file datve.js có thể sử dụng
